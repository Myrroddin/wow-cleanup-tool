...
TRANSLATIONS = {
    ...
    "tooltip_browse_wow_folder": "Select your main World of Warcraft installation folder.\n\nDo not select a subfolder (such as _retail_, _classic_, or AddOns). The tool requires the top-level WoW folder to function correctly.",
